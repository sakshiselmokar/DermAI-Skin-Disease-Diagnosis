...
const remedies = [
  Remedy(
    ...
    steps: [
      'Mix turmeric, honey and yoghurt in a small bowl until smooth.',
  ...
  Remedy(
    ...
    steps: [
      'Mix equal parts ACV and warm water in a bowl.',
      'Soak affected nails for 15-20 minutes.',
      'Dry nails completely with a clean towel.',
      'Trim and file nails after soaking while soft.',
      'Repeat daily for 4-6 weeks.',
      'Wear clean socks immediately after.',
    ],
  ...
  Remedy(
    ...
    steps: [
      'Dilute tea tree oil with carrier oil — never use undiluted.',
      'Clean the affected nail and surrounding skin.',
      'Apply the mixture with a cotton ball.',
      'Gently scrub the nail surface with a soft brush.',
      'Leave on and allow to absorb.',
  ...
  Remedy(
    ...
    steps: [
      ...
      'Add Dead Sea salts and stir to dissolve.',
      'Add olive oil for extra moisture.',
      'Soak for 15-20 minutes.',
      'Rinse lightly and pat dry.',
      'Apply thick moisturiser immediately.',
    ],
    tip: 'Dead Sea salt contains magnesium, which has anti-inflammatory effects on psoriasis plaques.',
  ),
  Remedy(
    name: 'Aloe & Turmeric Scalp Mask',
    disease: 'Psoriasis',
    emoji: '🌱',
    prepTime: '10 min',
    ...
    steps: [
      ...
      'Part hair and apply directly to scalp plaques.',
  ...
  Remedy(
    name: 'SPF Lip & Skin Protection',
    disease: 'Melanoma / Moles',
    emoji: '☀️',
    prepTime: '2 min',
    ingredients: ['SPF 50+ sunscreen', 'Zinc oxide cream (optional)', 'Wide-brimmed hat'],
    steps: [
      'Apply broad-spectrum SPF 50+ 20 minutes before going outside.',
      'Use a generous amount — 1/4 tsp for face alone.',
      'Apply zinc oxide to moles or suspicious spots for extra UV blocking.',
      'Reapply every 2 hours or after sweating/swimming.',
      'Cover up with UV-protective clothing.',
      'Check moles monthly using ABCDE method.',
    ],
...
const naturalIngredients = [
  NaturalIngredient(
    name: 'Aloe Vera',
    emoji: '🌿',
    benefit: 'Anti-inflammatory, cooling, moisturising. Contains vitamins C, E and enzymes.',
    bestFor: 'Eczema, sunburn, rosacea, general irritation',
    howToUse: 'Apply fresh gel directly from the leaf or use pure bottled gel. Leave on skin.',
  ),
  NaturalIngredient(
    name: 'Turmeric',
    emoji: '🟡',
    benefit: 'Curcumin is a powerful antioxidant and anti-inflammatory that fights bacteria.',
    bestFor: 'Acne, psoriasis, hyperpigmentation',
    howToUse: 'Mix with honey or yoghurt as a mask. Leave 10-15 min then rinse.',
  ),
  NaturalIngredient(
    name: 'Raw Honey',
    emoji: '🍯',
    benefit: 'Natural humectant, antibacterial, antifungal. Draws moisture into skin.',
    bestFor: 'Acne, dry skin, wound healing, eczema',
    howToUse: 'Apply directly as a spot treatment or mix with other ingredients for a mask.',
  ),
  NaturalIngredient(
    name: 'Coconut Oil',
    emoji: '🥥',
    benefit: 'Deeply moisturising, antifungal (lauric acid), repairs skin barrier.',
    bestFor: 'Eczema, nail fungus, dry skin, psoriasis',
    howToUse: 'Apply melted virgin coconut oil to skin or nails. Best after bathing.',
  ),
  NaturalIngredient(
    name: 'Tea Tree Oil',
    emoji: '🌲',
    benefit: 'Potent natural antifungal and antibacterial agent.',
    bestFor: 'Nail fungus, acne, infected skin',
    howToUse: 'Always dilute 1-2 drops in 1 tsp carrier oil. Never use undiluted.',
  ),
  NaturalIngredient(
    name: 'Apple Cider Vinegar',
    emoji: '🍎',
    benefit: 'Acidic pH balancer, antifungal and antibacterial properties.',
    bestFor: 'Nail fungus, acne, oily skin',
    howToUse: 'Always dilute 1:1 with water. Use as a toner or soak. Avoid on open wounds.',
  ),
  NaturalIngredient(
    name: 'Oatmeal',
    emoji: '🥣',
    benefit: 'Rich in beta-glucan, deeply soothing and anti-itch. Reinforces skin barrier.',
    bestFor: 'Eczema, dry skin, rashes, psoriasis',
    howToUse: 'Use colloidal oatmeal in baths or mix with water as a face mask.',
  ),
  NaturalIngredient(
    name: 'Chamomile',
    emoji: '🌼',
    benefit: 'Contains apigenin — anti-inflammatory, calming for sensitive and reactive skin.',
    bestFor: 'Rosacea, eczema, sensitive skin',
    howToUse: 'Brew strong tea, cool and apply as toner or compress. Mix with aloe vera gel.',
  ),
];
        ...
        children: [
          ...
          const Column(
            ...
            children: [
              ...
              Text('Natural treatments using kitchen ingredients',
  ...
  Widget _buildTabBar() {
    return Container(
      ...
      child: TabBar(
        ...
        tabs: const [
          Tab(text: 'Remedies by Disease'),
          Tab(text: 'Ingredient Benefits'),
        ],
      ),
    );
  }
      ...
      children: [
        ...
        Expanded(
          child: filtered.isEmpty
              ? const Center(
                  child: Text('No remedies for this condition yet.',
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Text(widget.remedy.emoji,
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Text(widget.remedy.disease,
                                  style: const TextStyle(
                                      fontSize: 10,
                                      color: c,
                                      fontWeight: FontWeight.w600)),
