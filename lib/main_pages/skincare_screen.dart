...
const morningSteps = [
  SkincareRoutineStep(
    ...
    description: 'Wash face with a mild, pH-balanced cleanser to remove overnight oils and impurities.',
    duration: '60 sec',
    icon: Icons.water_drop_outlined,
  ),
  SkincareRoutineStep(
    title: 'Toner',
    description: 'Apply alcohol-free toner to balance skin pH and prep for serums.',
    duration: '30 sec',
    icon: Icons.opacity_outlined,
  ),
  SkincareRoutineStep(
    title: 'Vitamin C Serum',
    description: 'Apply 2-3 drops for antioxidant protection, brightening and collagen support.',
    duration: '1 min',
    icon: Icons.brightness_high_outlined,
  ),
  SkincareRoutineStep(
    title: 'Moisturiser',
    description: 'Lock in hydration with a lightweight, non-comedogenic moisturiser.',
    duration: '30 sec',
    icon: Icons.water_outlined,
  ),
  SkincareRoutineStep(
    title: 'SPF Sunscreen',
    description: 'Apply SPF 30+ generously. This is the most important step.',
    duration: '1 min',
...
const nightSteps = [
  SkincareRoutineStep(
    title: 'Oil/Balm Cleanser',
    description: 'Double cleanse: start with an oil cleanser to dissolve sunscreen and makeup.',
    duration: '60 sec',
    icon: Icons.bubble_chart_outlined,
  ),
  SkincareRoutineStep(
    title: 'Foaming Cleanser',
    description: 'Follow with a water-based cleanser to remove remaining residue.',
    duration: '60 sec',
    icon: Icons.water_drop_outlined,
  ),
  SkincareRoutineStep(
    title: 'Exfoliant (2-3x/week)',
    description: 'Use AHA (glycolic/lactic acid) or BHA (salicylic) to remove dead skin cells.',
    duration: '5 min',
    icon: Icons.auto_awesome_outlined,
  ),
  SkincareRoutineStep(
    title: 'Treatment Serum',
    description: 'Apply niacinamide, retinol or hyaluronic acid serum based on your concern.',
    duration: '1 min',
    icon: Icons.science_outlined,
  ),
  SkincareRoutineStep(
    title: 'Night Cream / Slugging',
    description: 'Use a richer moisturiser or a thin layer of petroleum jelly to seal in moisture overnight.',
    duration: '30 sec',
...
const diseaseTips = [
  DiseaseSkintip(
    ...
    dos: [
      ...
      'Apply non-comedogenic moisturiser',
      'Change pillowcases every 2-3 days',
    ],
    donts: [
      'Do not pop or pick pimples',
      'Avoid heavy, oily makeup',
      'Do not over-exfoliate (max 2x per week)',
      'Avoid spicy food and alcohol for rosacea',
    ],
  ),
  DiseaseSkintip(
    disease: 'Eczema',
    ...
    donts: [
      ...
      'Avoid known allergens and stress triggers',
      'Do not scratch — apply cold compress instead',
    ],
  ),
  DiseaseSkintip(
    ...
    dos: [
      ...
      'Wear UV-protective clothing outdoors',
      'Do monthly self-checks using the ABCDE rule',
      'Visit a dermatologist annually for skin mapping',
    ],
    donts: [
      'Never skip sunscreen even on cloudy days',
      'Do not ignore new or changing moles',
  ...
  DiseaseSkintip(
    ...
    dos: [
      ...
      'Wear breathable socks and well-ventilated shoes',
      'Use antifungal powder in shoes',
      'Disinfect nail tools after each use',
    ],
    donts: [
      'Do not walk barefoot in public pools/gyms',
      'Avoid wearing tight, closed shoes all day',
      'Do not share nail clippers or files',
      'Avoid artificial nails while infected',
    ],
  ),
  DiseaseSkintip(
    disease: 'Psoriasis',
    ...
    dos: [
      ...
      'Get moderate sun exposure (5-10 min)',
      'Use coal tar or salicylic acid shampoo for scalp',
    ],
    donts: [
      'Do not smoke or drink alcohol excessively',
      'Avoid skin injury (cuts, sunburn)',
      'Do not use fragranced products on affected areas',
      'Do not stress — it is a known trigger',
    ],
  ),
];
        ...
        children: [
          ...
          const Column(
            ...
            children: [
              ...
              Text('Routines, tips & ingredients',
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Text(
          _isMorning ? '5 steps · ~4 minutes' : '5 steps · ~9 minutes',
          ...
          children: [
            GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                height: 32,
                decoration: BoxDecoration(
                  color: _done ? c : Colors.white,
                  shape: BoxShape.circle,
                  border: Border.all(
                    color: _done ? c : Colors.grey.shade300,
                    width: 2,
                  ),
                ),
                child: Center(
        ...
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _done ? c.withOpacity(0.3) : Colors.grey.shade200,
              ),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
                ...
                Row(
                  children: [
                    Icon(widget.step.icon,
                        size: 18, color: _done ? c : Colors.black54),
                    ...
                    Container(
                      ...
                      child: Text(widget.step.duration,
            ...
            itemBuilder: (_, i) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  child: Text(
                    '${diseaseTips[i].emoji}  ${diseaseTips[i].disease}',
                    style: TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.w600,
                      color: active ? Colors.white : Colors.black54,
        ...
        Container(
          ...
          child: const Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  'These tips help manage symptoms but are not a replacement for professional medical advice. Always consult a dermatologist.',
